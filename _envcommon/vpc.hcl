...
locals {
  ...
  # base_source_url = "git@github.com:terraform-aws-modules/terraform-aws-vpc.git//.?ref=master"
  base_source_url = "github.com/terraform-aws-modules/terraform-aws-vpc"
