...
locals {
  ...
  base_source_url = "github.com/terraform-aws-modules/terraform-aws-vpc//.?ref=v3.14.0"
...
generate "tfvars" {
  ...
  database_subnet_ipv6_prefixes = [8, 9, 10, 11]
  ...
  elasticache_subnet_ipv6_prefixes = [12, 13, 14, 15]
